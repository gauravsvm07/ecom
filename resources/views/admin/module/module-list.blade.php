	...
	<div class="content container-fluid">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<a href="{{url('auth/add-module')}}" class="btn btn-info">Add Module</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr row_id = "{{$row->id}}" class="get_row_{{$row->id}}">
										...
										<td>
											<div class="actions">
												<a class="btn btn-sm bg-success-light" href="{{url('auth/edit-module/'.$row->id)}}">
