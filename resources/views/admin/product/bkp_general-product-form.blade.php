							...
							<div class="col-xl-12">
								<div class="input-group control-group after_add_more_size">
									<div class="col-xl-12">
										...
										@if($product)
										@foreach($size_prices as $data)
										<div class="form-group row">
											{!!Form::label('name','Price/Size',['class'=>'col-lg-2 col-form-label'])!!}
											<div class="col-lg-5">
												{!!Form::text('display_price[]',$data->price,['class'=>'form-control','placeholder' => 'Price'])!!}
											</div>

											<div class="col-lg-5">
												{!!Form::text('display_size[]',$data->size,['class'=>'form-control','placeholder' => 'Size'])!!}
											</div>
...
<!-- <script type="">
$(".status_opt:nth-child(1)").css("color", "red");
</script> -->
