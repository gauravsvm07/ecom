			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">
						<a href="{{url('auth/add-display-product')}}" class="btn btn-info">Add Product</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr row_id="{{$row->product_id}}" class="get_row_{{$row->product_id}}">
										...
										<td>
											<div class="actions">
												<a class="btn btn-sm bg-success-light" href="{{url('auth/edit-display-product/'.$row->product_id)}}">
